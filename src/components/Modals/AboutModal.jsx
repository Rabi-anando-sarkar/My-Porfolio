...
const handleDrag = (e, data) => {
  ...
  return (
    ...
    >
      <div
      ref={nodeRef}
      className="about-container absolute bg-[#c4c4c49f] dark:bg-[#272727]"
      style={{
        zIndex,
        width: "50rem",
  height: "31rem"
    ...
    >
      <div className="about-bar cursor-move">
        <p className="text-white dark:text-black font-jetB text-[1.1rem] tracking-[0.25rem]">About</p>
        <button onClick={onClose} className="font-jetB text-red-600 text-lg font-bold">[X]</button>
      </div>
      <div className='about-scroll'>
        <div className='image-and-desc h-[12rem] flex items-center gap-20 pl-20 pr-8'>
          ...
          <div className='flex flex-col items-start'>
            <h2 className="text-4xl text-white dark:text-white font-jetB tracking-normal">Rabi Anando Sarkar</h2>
            <p className='text-xl pt-1 text-white dark:text-white font-jetB tracking-normal'>Full Stack Web Developer</p>
            <p className='text-sm pt-2 text-white dark:text-white font-jetB'>rabianandos2002@gmail.com || New Delhi, India</p>
          </div>
        </div>
        <div className='pl-8 pr-8 pt-8 pb-8'>
          <h2 className='text-xl font-jetB text-white dark:text-white pb-2'>What do I do :</h2>
          <p className='text-md font-jetB tracking-normal text-white dark:text-white'>
            Hi, I'm Rabi I... <br />
        ...
        <div className='pl-8 pr-8 pt-8 pb-8'>
          <h2 className='text-xl font-jetB text-white dark:text-white pb-2'>Education : </h2>
          <p className='text-md font-jetB tracking-normal text-white dark:text-white'>
        ...
        <div className='pl-8 pr-8 pt-8 pb-8'>
          <h2 className='text-xl font-jetB text-white dark:text-white pb-2'>Tech Stack : </h2>
          <p className='text-md font-jetB tracking-normal text-white dark:text-white'>
        ...
        <div className='pl-8 pr-8 pt-8 pb-2'>
          <h2 className='text-xl font-jetB text-white dark:text-white pb-2'>Also into :</h2>
          <p className='text-md font-jetB tracking-normal text-white dark:text-white'>
